...
for(var n=friends.length-1; n>1; n--){

    console.log("Guest # "+ (n+1) +') Dear '+ friends[n] +' sorry, I can not invite more than two guests.. ');
    friends.pop();
}

console.log("Dear " + friends[0] +" & "+ friends[1]+ " you are still invited.");
